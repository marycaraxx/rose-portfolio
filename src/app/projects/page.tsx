...
creativity soar.`,
  ...
  },
  {
    id: 2,
    name: "OJTify",
    description: `OJTify is more than just an OJT tracker—it’s your digital companion 
    throughout your internship journey. Designed to simplify attendance, daily accomplishments, 
    tasks, and progress monitoring, OJTify keeps everything organized in one place.`,
    link: "https://ojt-tracker-eta.vercel.app/",
    images: [
  ...
  },
  {
    id: 3,
    name: "DocTrack",
    description: `What if managing employee information could be simpler, faster, and more organized? 
    DocTrack transforms employee information into organized, accessible, and ready-to-use digital records—bringing employee management and ID generation together in one seamless platform.`,
