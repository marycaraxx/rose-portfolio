...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "mary.rose2345@gmail",
    href: "mailto:mary.rose2345@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/mary-rose/",
    content: "/mary-rose",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/marycaraxx",
    content: "/marycaraxx",
    icon: <FaGithub height={"50px"} />,
  },
  {
    name: "Resume",
    href: "/assets/Mary_Rose_Linga_Resume.html",
    content: "View Resume",
    icon: <VscCode height={"50px"} />,
    target: "_blank",
  },
];
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Mary Rose</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            <h1 className="text-3xl mb-10 lg:md-20">About me</h1>
              ...
              Hey there! I&apos;m Mary Rose, a Fullstack developer passionate about
